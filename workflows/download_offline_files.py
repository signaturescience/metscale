...
if __name__ == '__main__':
    ...
    parser.add_argument("--workflow", help="Download databases/images for inputed workflow", choices=['read_filtering', 'test_files'], required=True)
    ...
    if user_input in data.keys():
        for file_name,url in data[user_input].items():
